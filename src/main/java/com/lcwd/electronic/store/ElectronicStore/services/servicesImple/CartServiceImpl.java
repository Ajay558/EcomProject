...
import com.lcwd.electronic.store.ElectronicStore.reposittories.CartItemRepository;
...
//        cart.setItems(updatedItems);
    ...
    public void clearCart(String userId) {
        ...
        User user = userRepository.findById(userId).orElseThrow(() -> new ResourceNotFoundException("user not found found in data base"));
