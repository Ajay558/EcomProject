...
import com.lcwd.electronic.store.ElectronicStore.reposittories.RoleRepository;
...
public class UserServiceImpl  implements UserService {
    ...
    public UserDto createUser(UserDto userDto) {
        ...
        // entity -> dto
        UserDto newDto = entityDto(savedUser);
        return newDto;
    }
    ...
    public UserDto updateUser(UserDto userDto, String userId) {
        ...
        UserDto updatedDto = entityDto(updatedUser);
        return updatedDto;
    }
    ...
    public List<UserDto> searchUser(String keyword) {
       List<User> users = userRepository.findByNameContaining(keyword);
        List<UserDto> dtoList = users.stream().map(user -> entityDto(user)).collect(Collectors.toList());
        return dtoList;
    ...
    private UserDto entityDto(User savedUser) {
